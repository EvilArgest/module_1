...
class DeleteCatAdmin extends ConfirmFormBase {
   ...
   * {@inheritdoc}
   */
  public static function create(ContainerInterface $container): DeleteCatAdmin {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state):void {
    ...
    $form_state->setRedirect('cats.admin');
  }
