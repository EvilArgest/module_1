...
<div class=\"cat_table_name\">";
        ...
        echo "</div>
<div class=\"cat_table_email\">";
        // line 3
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["email"] ?? null), 3, $this->source), "html", null, true);
        echo "</div>
";
        // line 4
...
<div class=\"cat_table_name\">{{ name }}</div>
<div class=\"cat_table_email\">{{ email }}</div>
{{ image }}
<div class=\"cat_table_date\">{{ date }}</div>
</div>
